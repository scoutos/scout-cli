...
class WorkflowLogs {
    ...
    listLogs(request, requestOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const { workflow_id: workflowId, start_date: startDate, end_date: endDate, limit, session_id: sessionId, status, cursor, } = request;
            const _queryParams = {};
            ...
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                url: (0, url_join_1.default)((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.ScoutEnvironment.Prod, "v2/run_logs"),
                method: "GET",
                headers: {
