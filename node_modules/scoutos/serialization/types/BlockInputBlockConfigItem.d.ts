...
export declare const BlockInputBlockConfigItem: core.serialization.Schema<serializers.BlockInputBlockConfigItem.Raw, Scout.BlockInputBlockConfigItem>;
export declare namespace BlockInputBlockConfigItem {
    type Raw = BlockConfigItemBoolean.Raw | BlockConfigItemJson.Raw | BlockConfigItemNumber.Raw | BlockConfigItemLlm.Raw | BlockConfigItemSelect.Raw | BlockConfigItemTextLong.Raw | BlockConfigItemTextShort.Raw;
}
