...
exports.BlockOutput = void 0;
const core = __importStar(require("../../core"));
const BlockOutputBlockConfigItem_1 = require("./BlockOutputBlockConfigItem");
const Dependency_1 = require("./Dependency");
const NodeUi_1 = require("./NodeUi");
exports.BlockOutput = core.serialization.object({
    block_archetype_id: core.serialization.string(),
    block_config: core.serialization.list(BlockOutputBlockConfigItem_1.BlockOutputBlockConfigItem).optional(),
    ...
    dependencies: core.serialization.list(Dependency_1.Dependency).optional(),
