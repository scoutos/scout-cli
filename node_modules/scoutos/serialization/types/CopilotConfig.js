...
exports.CopilotConfig = void 0;
const core = __importStar(require("../../core"));
const CopilotConfigMode_1 = require("./CopilotConfigMode");
const CopilotConfigFabValue_1 = require("./CopilotConfigFabValue");
exports.CopilotConfig = core.serialization.object({
    ...
    mode: CopilotConfigMode_1.CopilotConfigMode.optional(),
    colors: core.serialization.record(core.serialization.string(), core.serialization.string()).optional(),
    fab: core.serialization.record(core.serialization.string(), CopilotConfigFabValue_1.CopilotConfigFabValue.optional()).optional(),
