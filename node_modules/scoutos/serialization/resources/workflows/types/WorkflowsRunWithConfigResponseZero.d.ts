...
export declare const WorkflowsRunWithConfigResponseZero: core.serialization.Schema<serializers.WorkflowsRunWithConfigResponseZero.Raw, Scout.WorkflowsRunWithConfigResponseZero>;
export declare namespace WorkflowsRunWithConfigResponseZero {
    type Raw = WorkflowRunStarted.Raw | WorkflowRunCompleted.Raw | WorkflowRunFailed.Raw | BlockRunStarted.Raw | BlockRunCompleted.Raw | BlockRunFailed.Raw | BlockStateUpdated.Raw;
}
