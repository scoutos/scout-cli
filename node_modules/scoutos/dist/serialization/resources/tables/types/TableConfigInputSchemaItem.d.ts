...
export declare const TableConfigInputSchemaItem: core.serialization.Schema<serializers.TableConfigInputSchemaItem.Raw, Scout.TableConfigInputSchemaItem>;
export declare namespace TableConfigInputSchemaItem {
    type Raw = CheckBoxColumn.Raw | JsonColumn.Raw | MarkdownColumn.Raw | NumberColumn.Raw | SelectColumn.Raw | TextLongColumn.Raw | TextShortColumn.Raw | UrlColumn.Raw;
}
